...
/* ── Local images ────────────────────────────────────────────────────── */
const paddyImg    = "/imports/sunlit-paddy-field-with-ripe-yellowing-rice-free-photo.jpg";
const maizeImg    = "/imports/360_F_1795549219_SUHJwqosehTz0QCnO09ZA7xPhhQugq0v.jpg";
const wheatImg    = "/imports/istockphoto-2153462364-612x612.jpg";
const soybeanImg  = "/imports/istockphoto-177429175-612x612.jpg";
const tomatoImg   = "/imports/images.jpg";
const potatoImg   = "/imports/istockphoto-460420375-612x612.jpg";
const onionImg    = "/imports/onions-thrive-in-rich-soil-promising-a-plentiful-harvest-photo.jpg";
...
/* ── Top bar (Removed for integration) ────────────────────────────────────────────────────────── */
...
function SuccessScreen({ crop, centre, quantity, unit, grade, onNavigate }: {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8 bg-[#F0FAF4] min-h-screen">
