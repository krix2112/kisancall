...
import { INITIAL_PAYMENTS, PaymentRecord } from '@/lib/staffMockData';
              ...
              <td className="py-3 px-4 text-right space-x-2">
                {item.status === 'Pending' && (
                  <button
                    ...
                    className={`text-white text-xs font-semibold py-1.5 px-3 rounded-lg shadow-sm transition-colors cursor-pointer ${loadingId === item.id ? 'bg-purple-400' : 'bg-purple-600 hover:bg-purple-700'}`}
                  >
                ...
                {item.status !== 'Paid' && (
                  <button
                    ...
                    className={`text-white text-xs font-semibold py-1.5 px-3 rounded-lg shadow-sm transition-colors cursor-pointer ${loadingId === item.id ? 'bg-emerald-400' : 'bg-emerald-600 hover:bg-emerald-700'}`}
                  >
