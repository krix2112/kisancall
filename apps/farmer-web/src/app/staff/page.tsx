...
import { MOCK_FARMERS, CAPACITY_BLOCKS } from '@/lib/staffMockData';
import { DataTable } from '@/components/staff/DataTable';

export default function StaffTodayOverviewPage() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-xs text-slate-500">Live operational metrics for Karnal Central Mandi</p>
      </div>
