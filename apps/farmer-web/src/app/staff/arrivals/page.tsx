...
import { INITIAL_ARRIVALS, ArrivalRecord } from '@/lib/staffMockData';
              ...
              <td className="py-3 px-4 text-right">
                {!item.arrived ? (
                  <button
                    ...
                    className={`font-semibold text-xs py-1.5 px-3 rounded-lg shadow-sm transition-colors text-white cursor-pointer ${
