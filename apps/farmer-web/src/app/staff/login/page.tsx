    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4 py-8">
      <div className="max-w-md w-full bg-white rounded-2xl p-8 shadow-xl space-y-6">
        ...
        {step === 'phone' ? (
          <form onSubmit={handleSendOtp} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-700 hover:bg-emerald-800 text-white font-semibold py-2.5 rounded-lg transition-colors shadow-sm disabled:opacity-50 text-xs cursor-pointer"
            >
        ...
        <div className="pt-4 border-t border-slate-200 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="p-2 bg-slate-50 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 rounded-lg text-left transition-all cursor-pointer"
            >
        ...
        <div className="pt-2 text-center">
          <Link href="/" className="text-xs text-slate-400 hover:text-emerald-700">
            ← Return to National Homepage
          </Link>
        </div>
      </div>
    </div>
