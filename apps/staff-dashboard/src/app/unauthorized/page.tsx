    ...
    <div className="max-w-xl mx-auto my-12 bg-white rounded-xl border border-rose-200 shadow-sm p-8 text-center space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600">
          You do not have the required role permissions (Admin) to view this page.
        </p>
      </div>
      ...
      <div className="flex justify-center gap-4 pt-2">
        <Link
          href="/"
          className="bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold py-2 px-5 rounded-lg transition-colors shadow-sm"
        >
          Return to Today Overview
        </Link>
        <Link
          href="/login"
          className="bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-semibold py-2 px-5 rounded-lg transition-colors border"
        >
