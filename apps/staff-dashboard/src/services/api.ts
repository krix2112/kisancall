...
export const staffApi = {
  /** Phase 4: Mark Arrival (Returns 501 currently in backend) */
  ...
  /** Phase 6: Procurement (Returns 501 currently in backend) */
  ...
  /** Phase 7: Payment (Returns 501 currently in backend) */
